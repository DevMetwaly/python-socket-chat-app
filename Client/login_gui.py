...
class LoginInterface:
    def __init__(self, top=None, color='navy'):
        ...
        self.login_button.configure(
            ...
            background="#c68747",
            borderwidth="1",
            command = lambda: self.login_handler(self.get_login_data(), soc),
            disabledforeground="#a3a3a3",
            font=font9,
            foreground="#000",
            highlightbackground="#d9d9d9",
        ...
        self.register_switch_btn.configure(
            ...
            command = lambda: self.switch_register(self.Register_Page),
            disabledforeground="#a3a3a3",
            foreground="#ffa6a6",
        ...
        self.signup_button.configure(
            ...
            background="#e5cadb",
            borderwidth="1",
            command = lambda: self.register_handler(self.get_registeration_data(), soc),
            disabledforeground="#a3a3a3",
            font=font9,
            foreground="#000",
            highlightbackground="#d9d9d9",
        ...
        self.reg_color_label = tk.Label(self.register_form)
        self.reg_color_label.place(relx=0.045, rely=0.58, height=25, width=38, bordermode='ignore')
        self.reg_color_label.configure(
            activebackground="#f9f9f9",
            activeforeground="black",
            background=self.background_color,
            disabledforeground="#a3a3a3",
        ...
        self.reg_colorbox = ttk.Combobox(self.register_form)
        self.reg_colorbox.place(relx=0.054, rely=0.667, relheight=0.083, relwidth=0.911, bordermode='ignore')
        self.value_list = ['blue', 'green', 'red', 'black', 'pink', 'navy']
        self.reg_colorbox.configure(
        ...
        self.login_switch_btn.configure(
            ...
            background=self.background_color,
            borderwidth="0", cursor='hand2',
            command = lambda: self.switch_login(self.Login_Page),
            disabledforeground="#a3a3a3",
            foreground="#ffa6a6",
            highlightbackground="#114",
            highlightcolor="black",
    ...
    def get_registeration_data(self):
        return {
            'username': self.reguser_textbox.get(),
            'password': self.regpass_textbox.get(),
            'fullname': self.reguser_textbox.get(),
            'color': self.reg_colorbox.get(),
            'gender': 'Male',
            'email': self.reguser_textbox.get() + '@gmail.com',
            'status': 'Online'
            }

    def login_handler(self, data, soc):
    ...
    def register_handler(self, data, soc):
    ...
    def switch_login(self, page):
        page.lift()
        print('Switching to Login page')
        sys.stdout.flush()

    def switch_register(self, page):
        page.lift()
